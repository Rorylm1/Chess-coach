...
import { IMAGINATIVE_PIECE_SETS } from "./imaginativePieceSets";
import { IMPORTED_PIECE_SETS } from "./importedPieceSets";

export type PieceType = "K" | "Q" | "R" | "B" | "N" | "P";
export interface PieceSet { vb: string; inner: Record<PieceType, string>; }
export const PIECE_SETS = { ...IMAGINATIVE_PIECE_SETS, ...IMPORTED_PIECE_SETS, ...${JSON.stringify(data)} } satisfies Record<string, PieceSet>;
